<template>
  <div class="header">{{ t('media.title') }}</div>
  <a-spin :spinning="loading" :delay="1000" :tip="t('common.downloading')" size="large">
...
const columns = [
  ...
  {
    title: t('media.payloadType'),
    dataIndex: 'payload'
  },
  {
    title: t('media.original'),
    dataIndex: 'is_original',
    slots: { customRender: 'original' }
  },
  {
    title: t('media.created'),
    dataIndex: 'create_time'
  },
  {
    title: t('media.action'),
